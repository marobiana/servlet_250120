...
<%
	...
	int id = Integer.valueOf(request.getParameter("id"));  // "1003" -> 1003
	//out.print(id);
...
%>
	...
	<div class="container d-flex">
		<div>
			<img src="<%= targetBook.get("image") %>" alt="표지" width="300">
		</div>
		<div>
			<div class="display-1 font-weight-bold"><%= targetBook.get("title") %></div>
